...
//Trapezoid
function areaOfTrapezoid(base1, base2, verticalHeight) {
  return (1 / 2) * (base1 + base2) * verticalHeight;
}

//Ellipse
function areaOfEllipse(radiusmMajorAxis, radiusmMinorAxis) {
  return 3.14159 * radiusmMajorAxis * radiusmMinorAxis;
}

// ======= End Of Area Formulas ========== //
